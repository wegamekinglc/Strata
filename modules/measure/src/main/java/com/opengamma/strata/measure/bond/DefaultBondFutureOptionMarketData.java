 ...
 * <p>
 * This uses a {@link BondFutureOptionMarketDataLookup} to provide a view on {@link MarketData}.
 */
@BeanDefinition(style = "light")
final class DefaultBondFutureOptionMarketData
    implements BondFutureOptionMarketData, ImmutableBean, Serializable {
   ...
   */
  public static DefaultBondFutureOptionMarketData of(
  ...
  private DefaultBondFutureOptionMarketData(
      BondFutureOptionMarketDataLookup lookup,
      MarketData marketData) {
   ...
   */
  private static final TypedMetaBean<DefaultBondFutureOptionMarketData> META_BEAN =
      LightMetaBean.of(DefaultBondFutureOptionMarketData.class, MethodHandles.lookup());
