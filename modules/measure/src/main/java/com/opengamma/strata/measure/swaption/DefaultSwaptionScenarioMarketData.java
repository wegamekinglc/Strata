...
final class DefaultSwaptionScenarioMarketData
    implements SwaptionScenarioMarketData, ImmutableBean, Serializable {
   ...
   */
  private static final TypedMetaBean<DefaultSwaptionScenarioMarketData> META_BEAN =
      LightMetaBean.of(DefaultSwaptionScenarioMarketData.class, MethodHandles.lookup());
  ...
  @Override
  public TypedMetaBean<DefaultSwaptionScenarioMarketData> metaBean() {
    return META_BEAN;
  }
