 ...
 * <p>
 * This uses a {@link FxOptionMarketDataLookup} to provide a view on {@link ScenarioMarketData}.
 */
@BeanDefinition(style = "light")
final class DefaultFxOptionScenarioMarketData
    implements FxOptionScenarioMarketData, ImmutableBean, Serializable {
   ...
   */
  public static DefaultFxOptionScenarioMarketData of(
      FxOptionMarketDataLookup lookup,
  ...
  private DefaultFxOptionScenarioMarketData(
      FxOptionMarketDataLookup lookup,
      ScenarioMarketData marketData) {
   ...
   */
  private static final TypedMetaBean<DefaultFxOptionScenarioMarketData> META_BEAN =
      LightMetaBean.of(DefaultFxOptionScenarioMarketData.class, MethodHandles.lookup());
