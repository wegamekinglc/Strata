...
/**
 * An identifier used to access a repo curve by name.
 * <p>
 * This is used when there is a need to obtain an instance of {@link Curve} as a repo curve.
 */
...
public final class RepoCurveId
   ...
   * @return the identifier
   */
  public static RepoCurveId of(CurveGroupName groupName, CurveName curveName) {
    return new RepoCurveId(groupName, curveName, ObservableSource.NONE);
  }
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code RepoCurveId}.
   * @return the meta-bean, not null
   */
  public static RepoCurveId.Meta meta() {
    return RepoCurveId.Meta.INSTANCE;
  }

  static {
    MetaBean.register(RepoCurveId.Meta.INSTANCE);
  }
  ...
  @Override
  public RepoCurveId.Meta metaBean() {
    return RepoCurveId.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      RepoCurveId other = (RepoCurveId) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", RepoCurveId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<CurveName> curveName = DirectMetaProperty.ofImmutable(
        this, "curveName", RepoCurveId.class, CurveName.class);
    /**
    ...
    private final MetaProperty<ObservableSource> observableSource = DirectMetaProperty.ofImmutable(
        this, "observableSource", RepoCurveId.class, ObservableSource.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends RepoCurveId> builder() {
      return new RepoCurveId.Builder();
    }

    @Override
    public Class<? extends RepoCurveId> beanType() {
      return RepoCurveId.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((RepoCurveId) bean).getCurveGroupName();
        case 771153946:  // curveName
          return ((RepoCurveId) bean).getCurveName();
        case 1793526590:  // observableSource
          return ((RepoCurveId) bean).getObservableSource();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code RepoCurveId}.
   */
  private static final class Builder extends DirectPrivateBeanBuilder<RepoCurveId> {
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("RepoCurveId.Builder{");
