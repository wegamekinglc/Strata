 ...
 * <p>
 * This is used when there is a need to obtain an instance of {@link Curve} as an issuer curve.
 */
...
public final class IssuerCurveId
  ...
  public static IssuerCurveId of(String groupName, String curveName) {
    return new IssuerCurveId(CurveGroupName.of(groupName), CurveName.of(curveName),
   ...
   */
  public static IssuerCurveId.Meta meta() {
    return IssuerCurveId.Meta.INSTANCE;
  }

  static {
    MetaBean.register(IssuerCurveId.Meta.INSTANCE);
  }
  ...
  @Override
  public IssuerCurveId.Meta metaBean() {
    return IssuerCurveId.Meta.INSTANCE;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", IssuerCurveId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<CurveName> curveName = DirectMetaProperty.ofImmutable(
        this, "curveName", IssuerCurveId.class, CurveName.class);
    /**
    ...
    private final MetaProperty<ObservableSource> observableSource = DirectMetaProperty.ofImmutable(
        this, "observableSource", IssuerCurveId.class, ObservableSource.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends IssuerCurveId> builder() {
      return new IssuerCurveId.Builder();
    }

    @Override
    public Class<? extends IssuerCurveId> beanType() {
      return IssuerCurveId.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((IssuerCurveId) bean).getCurveGroupName();
        case 771153946:  // curveName
          return ((IssuerCurveId) bean).getCurveName();
        case 1793526590:  // observableSource
          return ((IssuerCurveId) bean).getObservableSource();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code IssuerCurveId}.
   */
  private static final class Builder extends DirectPrivateBeanBuilder<IssuerCurveId> {
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("IssuerCurveId.Builder{");
