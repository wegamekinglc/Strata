...
public final class RepoCurveInputsId
...
//-------------------------------------------------------------------------
  ...
  */
  public static RepoCurveInputsId of(CurveGroupName groupName, CurveName curveName,
...
//-------------------------------------------------------------------------
   ...
   */
  public static RepoCurveInputsId.Meta meta() {
    return RepoCurveInputsId.Meta.INSTANCE;
  }

  static {
    MetaBean.register(RepoCurveInputsId.Meta.INSTANCE);
  }
  ...
  @Override
  public RepoCurveInputsId.Meta metaBean() {
    return RepoCurveInputsId.Meta.INSTANCE;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<CurveGroupName> curveGroupName = DirectMetaProperty.ofImmutable(
        this, "curveGroupName", RepoCurveInputsId.class, CurveGroupName.class);
    /**
    ...
    private final MetaProperty<CurveName> curveName = DirectMetaProperty.ofImmutable(
        this, "curveName", RepoCurveInputsId.class, CurveName.class);
    /**
    ...
    private final MetaProperty<ObservableSource> observableSource = DirectMetaProperty.ofImmutable(
        this, "observableSource", RepoCurveInputsId.class, ObservableSource.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends RepoCurveInputsId> builder() {
      return new RepoCurveInputsId.Builder();
    }

    @Override
    public Class<? extends RepoCurveInputsId> beanType() {
      return RepoCurveInputsId.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -382645893:  // curveGroupName
          return ((RepoCurveInputsId) bean).getCurveGroupName();
        case 771153946:  // curveName
          return ((RepoCurveInputsId) bean).getCurveName();
        case 1793526590:  // observableSource
          return ((RepoCurveInputsId) bean).getObservableSource();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code RepoCurveInputsId}.
   */
  private static final class Builder extends DirectPrivateBeanBuilder<RepoCurveInputsId> {
    ...
    @Override
    public RepoCurveInputsId build() {
      return new RepoCurveInputsId(
          curveGroupName,
          curveName,
          observableSource);
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("RepoCurveInputsId.Builder{");
